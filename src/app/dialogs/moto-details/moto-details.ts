...
@Component({
  ...
  templateUrl: './moto-details.html',
  styleUrl: './moto-details.css',
})
export class MotoDetails implements OnInit{
  private readonly data = inject(MAT_DIALOG_DATA);
  private readonly dialogRef = inject(MatDialogRef<MotoDetails>);
  private readonly attributiS = inject(AttibutiServices);
  private readonly motoS = inject(MotoServices);
